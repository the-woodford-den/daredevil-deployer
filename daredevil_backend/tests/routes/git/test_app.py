"""Feature tests for /git/app/ routes"""
...
from dependency.session import get_cookie_token, get_git_app_service
...
class TestGithubAppRoutes:
    ...
    async def test_get_app(self, client: AsyncClient):
        """Test searching for a Git App by slug"""
        ...
        app.dependency_overrides[get_git_app_service] = override_git_app_service

        mock_service = AsyncMock()
        mock_service.get = AsyncMock(return_value=mock_git_app)
